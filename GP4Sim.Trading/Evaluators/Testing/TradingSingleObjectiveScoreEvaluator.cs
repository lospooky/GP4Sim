...
{
    [Item("Trading Score Evaluator", "Trading Score Evaluator")]
    [StorableClass]
    public class TradingSingleObjectiveScoreEvaluator : TradingSingleObjectiveEvaluator
    {
        public override bool Maximization { get { return true; } }

        #region Constructors
        [StorableConstructor]
        protected TradingSingleObjectiveScoreEvaluator(bool deserializing) : base(deserializing) { }
        protected TradingSingleObjectiveScoreEvaluator(TradingSingleObjectiveScoreEvaluator original, Cloner cloner)
            : base(original, cloner) { }

        public TradingSingleObjectiveScoreEvaluator() : base(TradingFitnessType.Score) { }

        [StorableHook(HookType.AfterDeserialization)]
        private void AfterDeserialization()
        {
            evalType = TradingFitnessType.Score;
        }


        public override IDeepCloneable Clone(Cloner cloner)
        {
            return new TradingSingleObjectiveScoreEvaluator(this, cloner);
        }
        #endregion
