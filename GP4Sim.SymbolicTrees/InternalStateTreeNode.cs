...
{
    [StorableClass]
    public class InternalStateTreeNode : SymbolicExpressionTreeTerminalNode
    {
        public new InternalState Symbol
        {
            get { return (InternalState)base.Symbol; }
        }
        [Storable]
        ...
        [StorableConstructor]
        protected InternalStateTreeNode(bool deserializing) : base(deserializing) { }
        protected InternalStateTreeNode(InternalStateTreeNode original, Cloner cloner)
            : base(original, cloner)
        {
            weight = original.weight;
            variableName = original.variableName;
        }
        protected InternalStateTreeNode() { }
        public InternalStateTreeNode(InternalState variableSymbol) : base(variableSymbol) { }
        ...
        public override void ResetLocalParameters(IRandom random)
        {
            ...
            variableName = Symbol.InternalStateNames.SelectRandom(random);
        }
        ...
        {
            return new InternalStateTreeNode(this, cloner);
        }
