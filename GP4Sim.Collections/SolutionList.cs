...
{
    [StorableClass]
    [Item("ItemList", "Represents a list of items.")]
    public class SolutionList<T> : ObservableList<T>, IItemList<T> where T : class, IItem
    {
        ...
        [StorableConstructor]
        protected SolutionList(bool deserializing) : base(deserializing) { }
        protected SolutionList(SolutionList<T> original, Cloner cloner)
        {
        ...
        public SolutionList(IEnumerable<T> collection) : base(collection) { }
        ...
        {
            return new SolutionList<T>(this, cloner);
        }
